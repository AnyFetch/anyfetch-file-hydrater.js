...
var hydrationError = require('../index.js').hydrationError;
  ...
  return function(task, done) {
    ...
    async.waterfall([
      ...
      function hydration(path, cb) {
        ...
        ], function cleanHydration(err, path, changes, domain) {
          if(typeof(err) === "hydrationError") {
            changes = {
